...
Not applicable, it means there is no admissions data in 2021 for some of the attractions, so when finding a mean or median the function runs into an error
...
**Write your answer here**
That it's more common for an attraction to have fewer visitors but some attractions have so many visitors the mean is higher.
...
```{r Ex_m}
visitors_with_nations %>%
  mutate(visitors_with_nations,
         proportion = count(filter(visitors_with_nations,admission == "Free")) / count(attraction))
